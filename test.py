...
my_strings = ["louis", "la", "Grange", "works", "very", "hard", "LOoooooooooooooooooooooooooooooooooongs striiiiiiiiiiiiiiiinnnnnngggggggggggggg"]

print(gen_dictionary(my_strings))

def decode_string(string):
    decoded_string = zlib.decompress(string)
